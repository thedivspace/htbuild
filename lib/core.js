...
const componentRegex = /(<\s*ht-component\s*data-component="+([A-Za-z0-9_\/])+"\s*\/>)/gm;
const variableRegex = /(<\s*ht-variable\s*data-var="+([A-Za-z0-9_\/])+"\s*data-val="+([A-Za-z0-9_\/\s*.])+"\s*\/>)/gm;
